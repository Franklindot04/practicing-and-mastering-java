...
Use this file to track learning honestly. Mark topics only when you can explain them and write code without copying.

## Current Focus

- [ ] Install Java 21
- [ ] Run Hello World
- [ ] Complete Java basics notes
- [ ] Complete Java basics exercises
- [ ] Build first beginner project
- [ ] Take beginner Java quizzes
- [ ] Review beginner solutions after attempting the work

## Beginner Path Checklist

- [ ] Read [Getting Started](docs/00-getting-started/README.md)
- [ ] Study [Java Basics](docs/01-java-basics/README.md)
- [ ] Run and change [beginner examples](examples/beginner/README.md)
- [ ] Complete [beginner exercises](exercises/beginner/README.md)
- [ ] Build [Calculator CLI](projects/beginner/calculator-cli/README.md)
- [ ] Build [Number Guessing Game](projects/beginner/number-guessing-game/README.md)
- [ ] Build [To-Do List CLI](projects/beginner/todo-list-cli/README.md)
- [ ] Complete [beginner quizzes](quizzes/beginner/README.md)
- [ ] Review [beginner solutions](solutions/beginner/README.md)
- [ ] Explain what you learned in your own words before starting OOP
...
Status: feature branches prepared; not merged.

- Reliability engineering foundations: branch prepared
- Timeouts, deadlines, retries, and backoff: branch prepared
- Circuit breakers, bulkheads, and fallbacks: branch prepared
- Idempotency, load shedding, and recovery: branch prepared
- Java resilience pattern examples: branch prepared
- Reliable service simulator: branch prepared
- Disaster recovery and chaos engineering: branch prepared
- Exercises and solutions: branch prepared
- Quizzes and answer key: branch prepared
- Learning flow updates: branch prepared
